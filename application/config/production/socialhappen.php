...
$config['mongodb_database'] = 'hotanalyzer';

//Facebook : Fill these if you want to use facebook library
$config['facebook_app_id'] = '438626169483132';
$config['facebook_app_secret'] = 'e2753b1816d2ef4ac8a2d9762b40a2fc';
...
$config['static_server_path'] = 'http://static.socialhappen.com/apps/hotanalyzer/';
