	...
	function upload() {
		...
		try {
			...
			if(isset($user['name'])) {	
				...
				//Shadow
				imagettftext($background_image, 15, 0, $profile_image_x + 2, $profile_image_y + $profile_image_size + 25, $white, $font_file, $user['name']);
				imagettftext($background_image, 15, 0, $profile_image_x, $profile_image_y + $profile_image_size + 23, $grey, $font_file, $user['name']);
			}
